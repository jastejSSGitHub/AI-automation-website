...
Replace lines 1948-2151 (the entire case studies grid section) with the following 2-column card grid:

```html
        <!-- Case Studies Grid - 2 Per Row -->
...
This replaces the alternating image-text layout with a clean 2-column card grid where:
- 2 case studies appear side-by-side per row
- All 6 case studies are visible (no expand/collapse)
- Mobile: stacks to single column
- Tablet/Desktop: 2 columns
- "View All" button links to case-studies.html page
